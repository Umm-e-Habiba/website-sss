        ...
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="TERMS & CONDITIONS">
                <div>
                    ...
                    <div className="terms-content-section bg-29 section-padding">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="terms-content bg-white p-5 rounded shadow-lg">
                                        ...
                                        <div className="terms-section mb-5">
                                            ...
                                            <h4 className="subsection-title mt-4 mb-3" style={{color: '#243D31'}}>1.1 Definitions</h4>
                                            <p className="mb-3">In this agreement:</p>
                                            
                                            <div className="definition-list">
                                                <div className="definition-item mb-3">
                                                    <strong>CCA</strong> means Schedule 2 to the Competition and Consumer Act 2010 (Cth) and the corresponding provisions of the applicable fair trading legislation in the State or Territory in which this agreement is entered into, as applicable.
                                                </div>
                                                
                                                <div className="definition-item mb-3">
                                                    <strong>Additional Provisions</strong> means the additional provisions set out in item 9.
                                                </div>
                                                
                                                <div className="definition-item mb-3">
                                                    <strong>Australian Consumer Law</strong> means the Australian Consumer Law as set out at Schedule 2 of the CCA.
                                                </div>
                                                ...
                                                <div className="definition-item mb-3">
                                                    <strong>Claim</strong> means any claim or cause of action in contract, tort, under any legislation or subordinate legislation, or otherwise.
                                                </div>
                                                
                                                <div className="definition-item mb-3">
                                                    <strong>Client Group</strong> means the Client and each of its Related Bodies Corporate and Client Group Member means any member of the Client Group.
                                                </div>
                                                
                                                <div className="definition-item mb-3">
                                                    <strong>Client's Obligations</strong> means all of the liabilities, obligations and requirements (whether express or implied) from time to time imposed on, or assumed by, the Client:
                                                    <ul className="mt-2">
                                        ...
                                        <div className="terms-section mb-5">
                                            ...
                                            <h4 className="subsection-title mt-4 mb-3" style={{color: '#243D31'}}>3.1 Supply of Services</h4>
                                            ...
                                            <h4 className="subsection-title mt-4 mb-3" style={{color: '#243D31'}}>3.2 Acknowledgement of Services</h4>
                                            ...
                                            <h4 className="subsection-title mt-4 mb-3" style={{color: '#243D31'}}>3.3 Shared Services and Replacement Services</h4>
                                            ...
                                            <h4 className="subsection-title mt-4 mb-3" style={{color: '#243D31'}}>3.4 Additional Services</h4>
                                            ...
                                            <h4 className="subsection-title mt-4 mb-3" style={{color: '#243D31'}}>3.5 Assignment and Subcontracting</h4>
                                        ...
                                        <div className="terms-section mb-5">
                                            ...
                                            <h4 className="subsection-title mt-4 mb-3" style={{color: '#243D31'}}>6.1 Service Fees</h4>
                                            <ul className="terms-list">
                                            ...
                                            <h4 className="subsection-title mt-4 mb-3" style={{color: '#243D31'}}>6.2 Payment Terms</h4>
                                            <ul className="terms-list">
                                        ...
                                        <div className="terms-section mb-5">
                                            ...
                                            <h3 className="section-title mb-4 mt-5" style={{color: '#243D31', borderBottom: '2px solid #FDC24C', paddingBottom: '10px'}}>
                    ...
                    <div className="contact-info-section bg-28 section-padding">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="contact-banner bg-primary text-white p-5 rounded text-center">
                                        <div className="row align-items-center">
                                            <div className="col-lg-8 text-left">
                                                <h3 className="text-white mb-3">Questions About Our Terms?</h3>
                                                <p className="text-white mb-0">
                                                    If you have any questions about these terms and conditions or need clarification on any aspect of our service agreement, please don't hesitate to contact us.
                                                </p>
                                            </div>
