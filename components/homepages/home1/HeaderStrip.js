      ...
      <div className="container d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <div className="d-flex align-items-center flex-wrap gap-3">
          ...
          <div className="d-flex align-items-center gap-3">
            <a href="https://facebook.com" aria-label="Facebook" className="text-white text-decoration-none">
              <i className="fa-brands fa-facebook-f"></i>
            </a>
            <a href="https://twitter.com" aria-label="Twitter/X" className="text-white text-decoration-none">
              <i className="fa-brands fa-x-twitter"></i>
            </a>
            <a href="https://instagram.com" aria-label="Instagram" className="text-white text-decoration-none">
              <i className="fa-brands fa-instagram"></i>
            </a>
            <a href="https://linkedin.com" aria-label="LinkedIn" className="text-white text-decoration-none">
